(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["DMHello"] = factory();
	else
		root["DMHello"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/hello/index.tsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/css-loader/index.js!./node_modules/resolve-url-loader/index.js!./node_modules/less-loader/dist/cjs.js!./src/hello/_hello.less":
/*!**********************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/resolve-url-loader!./node_modules/less-loader/dist/cjs.js!./src/hello/_hello.less ***!
  \**********************************************************************************************************************************/
...
/*!******************************************!*\
  !*** ./node_modules/omi/dist/omi.esm.js ***!
  \******************************************/
/*! exports provided: default, tag, WeElement, Component, render, h, createElement, options, define, observe, cloneElement, getHost, rpx, tick, nextTick, ModelView, defineElement, classNames, extractClass, createRef, html, htm, o, elements, $, extend, get, set */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/resolve-url-loader!../../node_modules/less-loader/dist/cjs.js!./_hello.less */ "./node_modules/css-loader/index.js!./node_modules/resolve-url-loader/index.js!./node_modules/less-loader/dist/cjs.js!./src/hello/_hello.less");
...
var HelloElement = /** @class */ (function (_super) {
    __extends(HelloElement, _super);
    function HelloElement() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onClick = function (evt) {
            // trigger CustomEvent
            _this.fire('abc', { name: 'Mc', age: 12 });
            evt.stopPropagation();
        };
        return _this;
    }
    HelloElement.prototype.installed = function () {
        console.log(this.css);
    };
    HelloElement.prototype.render = function (props) {
        return (omi_1.h("div", { onClick: this.onClick },
            omi_1.h("h2", null,
                "Hi ",
                props.msg),
            omi_1.h("div", null, "Click Me!"),
            props.list.map(function (item) { return (omi_1.h("a", { href: item.url, target: "_blank" }, item.name)); })));
    };
    //如果需要在 html 里直接使用 <dm-hello></dm-hello>，必须声明 propTypes
    HelloElement.propTypes = {
        msg: String,
        list: Array
    };
    HelloElement.css = __webpack_require__(/*! ./_hello.less */ "./src/hello/_hello.less");
    HelloElement = __decorate([
        omi_1.tag('dm-hello')
    ], HelloElement);
    return HelloElement;
}(omi_1.WeElement));
exports.default = HelloElement;
